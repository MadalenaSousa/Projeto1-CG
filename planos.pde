class Planos {
  ...
  Planos(String tipo) {
    ...
    chao = createShape();
    chao.setFill(color(90, 61, 7));
    chao.setTexture(wood);
    ...
    parede1 = createShape();
    parede1.setFill(color(152, 111, 61));
    parede1.setTexture(wallpaper);
    ...
    parede2 = createShape();
    parede2.setFill(color(152, 111, 61));
    parede2.setTexture(wallpaper);
    ...
    parede3 = createShape();
    parede3.setFill(color(152, 111, 61));
    parede3.setTexture(wallpaper);
    ...
    //frente da cadeira
    parede4 = createShape();
    parede4.setFill(color(152, 111, 61));
    parede4.setTexture(wallpaper);
